...
public class HttpTopmodelMainTest {
	public static void execute(){
		...
		String Base_Dir = "/home/fgao/websocket/openmi/topmodel/";
...
//		hargreavesModel.getTimeHorizon()
		...
		Argument TopmodeloutputFileArgument = new Argument("OutputData",Base_Dir+"HTTPTopmodel_output.txt",true);
		Argument topmodelProvOutArgument = new Argument("ProvOut",Base_Dir+"HTTPTopmodel_prov.txt",true);
...
//		componet1.dispose();
	...
	public static void main(String[] args){
		...
		for(int i=0;i<5;i++){
		new HttpTopmodelMainTest().execute();
		}
		long end_time = System.currentTimeMillis();
		System.out.println("Http用时"+(end_time-start_time)/5);*/
