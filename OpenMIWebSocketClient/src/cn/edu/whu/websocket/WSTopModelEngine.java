...
public class WSTopModelEngine extends SimpleWrapper {
	...
	private String wsUrl = "ws://localhost:8080/OpenMIWebSocketServer/ws/topmodel?";
...
//					System.out.println("the client named " + name+ " recieve message:" + message);
					...
					double[] val = { d1 };
					setValues(quantity, element, new ScalarSet(val));
					flag = false;
				}
	...
	public static void main(String[] args) {
		...
		WSTopModelEngine engine = new WSTopModelEngine();
